  ...
  describe("POST /api/auth", () =>{
    describe("with valid credentials", () => {
      it('returns a token', async () => {
        const response = await app.post('/api/auth').send({username: 'larry', password: 'larry_pw'})
    ...
    describe("with invalid credentials", () => {
      it('returns a token', async () => {
        const response = await app.post('/api/auth').send({username: 'larry', password: 'larry'})
  ...
  describe("GET /api/auth", () =>{
    describe("with valid token", () => {
      it('returns a user', async () => {
        const token = await jwt.sign({id: seed.users.lucy.id}, process.env.JWT)
